...
from behaviorci.runner.engine import RunResult, CaseResult
...
class DiffReporter(Reporter):
    ...
    def generate_markdown_report(self, diff_result: DiffResult) -> str:
        ...
        # Header
        lines.append(f"# BehaviorCI Diff Report: {diff_result.current.bundle_name}")
        lines.append("")
        ...
        # Footer
        lines.append("---")
        lines.append(f"*Generated by BehaviorCI at {diff_result.current.started_at.isoformat()}*")
